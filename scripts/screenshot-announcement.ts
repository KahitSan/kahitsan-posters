...
const SCREENSHOT_DIR = 'screenshots/announcements/early-closing-dec-21-2025'
...
async function generateScreenshots() {
  ...
  try {
    ...
    await page.goto(`${BASE_URL}/announcement/early-closing-dec-21`)
    ...
    await page.goto(`${BASE_URL}/announcement/early-closing-dec-21?dark`)
    await page.waitForLoadState('networkidle')
    await page.screenshot({
