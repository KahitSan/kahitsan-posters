...
const SCREENSHOT_DIR = 'screenshots/announcements/booking-hours'
...
async function generateScreenshots() {
  ...
  try {
    ...
    await page.goto(`${BASE_URL}/announcement/booking-hours`)
    ...
    await page.goto(`${BASE_URL}/announcement/booking-hours?dark`)
    await page.waitForLoadState('networkidle')
    await page.screenshot({
