...
const SCREENSHOT_DIR = 'screenshots/announcements/cleaning-jan-10-2026'
...
async function generateScreenshots() {
  ...
  try {
    ...
    await page.goto(`${BASE_URL}/announcement/cleaning-jan-10-2026`)
    ...
    await page.goto(`${BASE_URL}/announcement/cleaning-jan-10-2026?dark`)
    await page.waitForLoadState('networkidle')
    await page.screenshot({
