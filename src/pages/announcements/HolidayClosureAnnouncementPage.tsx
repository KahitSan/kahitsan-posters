...
export default function HolidayClosureAnnouncementPage() {
    ...
    <>
      ...
      <section class="relative w-full" style={{ background: bgColor() }}>
        ...
        >
            ...
            <div class="mb-4">
              <div class="announcement-badge">
                <div class="tracking-widest font-black text-black text-2xl">
                  Holiday <span class="italic">Closure</span>
                </div>
              </div>
            </div>
            <div class="mb-2">
          ...
          {/* Footer */}
          <div class={`text-center mt-12 pt-10 border-t ${isDark() ? 'border-amber-500/20' : 'border-amber-200'}`}>
